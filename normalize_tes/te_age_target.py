...
def load_polarity_selection(
    ...
    if metadata.get("schema_version") != "te-polarity-mask-v1":
        raise SystemExit(
            ...
            "normalize_tes.build_te_polarity_mask"
        )
    ...
    if not expected or not recorded:
        raise SystemExit(
            ...
            "normalize_tes.build_te_polarity_mask against this store."
        )
    ...
    if covered is None:
        raise SystemExit(
            ...
            "aligned to the store; rebuild it with normalize_tes.build_te_polarity_mask"
        )
